...
inline f2i_index_format_t const* f2i_findIndexFormat(char const* id) {
...
inline f2i_color_format_t const* f2i_findColorFormat(char const* id) {
...
inline f2i_block_format_t const* f2i_findBlockFormat(char const* id) {
